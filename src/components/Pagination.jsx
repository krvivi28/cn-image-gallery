    ...
    <>
      <div className="flex flex-col items-center">
        <span className="text-sm text-gray-700 dark:text-gray-400">
          Showing{" "}
          <span className="font-semibold text-white ">{props.cpage}</span> to{" "}
          <span className="font-semibold text-white">{props.cpage * 10}</span>{" "}
          of <span className="font-semibold text-white">1000</span> Entries
        </span>
